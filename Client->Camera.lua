...
--[[
omnidirectional orbital custom camera with simple collisions
]]
...
return function(loaded:loaded,char:char)	
	...
	local function UpdateCam(dt:number)
		...
		-- this part is too annoying to explain but i make cam goalcf and check colls		
		...
		if ray then
			...
			SetInstanceNewIndex( --"raw set" the cframe with RawLib
				cam,
				'CFrame',
